    ...
    <>
      <div className="container pt-5">
          ...
          <div className="d-sm-flex justify-content-sm-between">
            ...
            <div className="mt-5">
              <div className="content text-center text-md-start fs-3 pt-3 p-md-5 ">
                ...
                <span className="h1">
                  {" "}
                  Taste-Pal Restaurant our brand awareness to neighborhoods that
        ...
        <section className="d-md-none d-block  justify-content-md-between align-items-center px-4 py-5">
          ...
          <div className="text-center">
            <div className="list mx-auto">
              Join over 30 restaurants already on  Taste-Pal Restaurant
            </div>
        ...
        <section className="p-2 text-center">
          <div className="mb-5">
            <h2 className="black fw-bold">How  Taste-Pal Restaurant Works ?</h2>
          </div>
        ...
        <section className="px-3 px-md-2">
          <div>
            ...
            <div className="mb-4">
              ...
              <span className="paragraph">
              Tast-Pal Restaurant offers professional photo shoot for the restaurants
            ...
            <div className="mb-4">
              ...
              <span className="paragraph">
                The  Taste-Pal Restaurant platform can connect you with independent drivers
